                ...
                <form action="/admin/album/store" role="form" enctype="multipart/form-data" method="POST" id="frm-themmoi">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="noidung" class="form-control required" row="8" placeholder="Nội dung" ></textarea>
                            <div class="note-error">
                                <span class="error mes-note-error" id="errNoiDung"></span>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-priamry">Thêm mới</button>
                    </div>
                </form>
            </div>
        </div>
